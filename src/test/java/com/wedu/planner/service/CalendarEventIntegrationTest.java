...
class CalendarEventIntegrationTest {
    ...
    void getMonthlyEvents() {
        ...
        create(1L, "오전 일정", LocalDate.of(2026, 7, 12),
                Instant.parse("2026-07-12T11:00:00Z"), CalendarEventCategory.STUDIO_DRESS);
        create(1L, "오후 일정", LocalDate.of(2026, 7, 12),
                Instant.parse("2026-07-12T14:00:00Z"), CalendarEventCategory.STUDIO_DRESS);
    ...
    @Test
    @DisplayName("다가오는 일정은 오늘 종일 일정과 현재 이후 일정만 조회한다")
    void getUpcomingEventsExcludesPastTimedEvents() {
        ...
        create(1L, "이미 지난 일정", TODAY,
                Instant.parse("2026-07-21T09:00:00Z"), CalendarEventCategory.OTHER);
        create(1L, "현재 시각 일정", TODAY, NOW, CalendarEventCategory.OTHER);
        create(1L, "오늘 이후 일정", TODAY,
                Instant.parse("2026-07-21T11:00:00Z"), CalendarEventCategory.OTHER);
                        ...
                        .content("""
                                {
                                  ...
                                  "eventAt":"2026-07-21T11:00:00Z",
                                  "category":"STUDIO_DRESS",
                                  "memo":"피팅 준비"
                                }
                                """))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.eventAt").value("2026-07-21T11:00:00Z"))
