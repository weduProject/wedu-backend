...
public class InvitationController {
    ...
    public ApiResponse<InvitationResponse> create(
        ...
        return ApiResponse.ok(invitationService.create(userId, request));
    }
    ...
    public ApiResponse<InvitationResponse> getMine(
        ...
        return ApiResponse.ok(invitationService.getMine(userId));
    }
    ...
    public ApiResponse<InvitationResponse> update(
        ...
        return ApiResponse.ok(invitationService.update(userId, request));
    }
    ...
    public ApiResponse<InvitationResponse> publish(
        ...
        return ApiResponse.ok(invitationService.publish(userId));
    }
}